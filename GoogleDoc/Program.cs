...
namespace GoogleDoc
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            using (var stream =
                new FileStream(@"D:\Projects\GitLocal\DemoSou\GoogleDoc\credentials.json", FileMode.Open, FileAccess.Read))
            {
            ...
            String documentId = "1EXSMM1qY56nfVWrMjp0-KVLmz0u6BGyufepRQEgkO-Y";
